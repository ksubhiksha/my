    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          //content: options.content + '&nbsp;<p class="button-group" style="text-align: center;"><button type="button" id="confirmYes"  style="width: 80px;" class="btn btn-success btn-md confirm-dialog-btn-confirm">' + options.yesBtn + '</button><input type="hidden" id="confirmNo" style="display:none" >'+options.emptyBtn +'</input><button type="button" id="confirmNo" style="width: 100px;" class="btn btn-danger btn-md confirm-dialog-btn-abord">' + options.noBtn + '</button></p>'
